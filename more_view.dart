...
class _MoreViewState extends State<MoreView> {
  // List containing menu options with name, image, and notification count
  List moreArr = [
    {
      "index": "1",
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // Shopping cart button navigating to MyOrderView
                    IconButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            // Background container with icon and text
                            Container(
